...
public class OpenSimplexNoise {
	...
	private static final double STRETCH_CONSTANT_2D = (1/Math.sqrt(2+1)-1)/2;    //(1/Math.sqrt(2+1)-1)/2;
	private static final double SQUISH_CONSTANT_2D = (Math.sqrt(2+1)-1)/2;      //(Math.sqrt(2+1)-1)/2;
	...
	private static final byte a2 = 5, b2 = 2;
